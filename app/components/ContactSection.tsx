	...
	return (
		<section className="py-20 px-4">
			<div className="max-w-4xl mx-auto">
				...
				>
					<div className="absolute inset-0 bg-gradient-to-br from-blue-900 to-teal-500 opacity-10" />
					<div className="absolute inset-0 bg-[url('/grid.svg')] bg-center opacity-20" />
					<div className="relative z-10">
						<motion.div initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }}>
							<h2 className="text-4xl font-bold mb-3 text-center bg-gradient-to-r from-blue-900 to-teal-500 text-transparent bg-clip-text">
								Contáctame
							</h2>
							<div className="flex items-center justify-center gap-2 text-gray-400 mb-4">
								...
								<span>Zacatecas, Zacatecas, México</span>
							</div>
							<div className="flex items-center justify-center gap-2 text-gray-400 mb-8">
								...
								<span>+52 492 239 4111</span>
							</div>

						</motion.div>
						<div className="flex flex-col items-center gap-6 mb-8">
							<motion.a
								href="mailto:ivanmart9503@gmail.com"
								whileHover={{ scale: 1.05 }}
								whileTap={{ scale: 0.95 }}
								className="w-full sm:w-auto flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-r from-blue-900 to-teal-500 rounded-2xl transition-all duration-500 font-medium text-white"
							>
								<svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
									<path
										strokeLinecap="round"
						...
						<div className="flex flex-wrap justify-center gap-6">
							<motion.a
								href="https://www.linkedin.com/in/ivanmart9503"
								target="_blank"
								whileHover={{ scale: 1.05 }}
								whileTap={{ scale: 0.95 }}
